...
public class CarControllerEditor : Editor
{
  ...
  string[] options = new string[] { "Front-Wheel Drive", "Rear-Wheel Drive", "All-Wheel Drive" };
  ...
  private void OnEnable()
  {
    ...
    FLWParticleSystem = SO.FindProperty("RLWParticleSystem");
    FRWParticleSystem = SO.FindProperty("RRWParticleSystem");
    RLWTireSkid = SO.FindProperty("RLWTireSkid");
    RRWTireSkid = SO.FindProperty("RRWTireSkid");
    FLWTireSkid = SO.FindProperty("RLWTireSkid");
    FRWTireSkid = SO.FindProperty("RRWTireSkid");
   ...
   public override void OnInspectorGUI()
   {
    ...
    car.carDriveType = (CarDriveType)EditorGUILayout.EnumPopup("Drive Type", car.carDriveType);
    ...
    GUILayout.Space(10);
    EditorGUILayout.PropertyField(RLWTireSkid, new GUIContent("Front Left Trail Renderer: "));
    EditorGUILayout.PropertyField(RRWTireSkid, new GUIContent("Front Right Trail Renderer: "));
