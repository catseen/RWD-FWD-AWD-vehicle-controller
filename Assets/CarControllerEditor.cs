...
public class CarControllerEditor : Editor
{
    ...
    private SerializedProperty FLWParticleSystem;
    private SerializedProperty FRWParticleSystem;
    private SerializedProperty RLWTireSkid;
    private SerializedProperty RRWTireSkid;
    private SerializedProperty FLWTireSkid;
    private SerializedProperty FRWTireSkid;
    ...
    private void OnEnable()
    {
        ...
        FLWParticleSystem = SO.FindProperty("FLWParticleSystem");
        FRWParticleSystem = SO.FindProperty("FRWParticleSystem");
        RLWTireSkid = SO.FindProperty("RLWTireSkid");
        RRWTireSkid = SO.FindProperty("RRWTireSkid");
        FLWTireSkid = SO.FindProperty("FLWTireSkid");
        FRWTireSkid = SO.FindProperty("FRWTireSkid");
    ...
    public override void OnInspectorGUI()
    {
        ...
        SerializedProperty driveTypeProp = serializedObject.FindProperty("carDriveType");
        EditorGUILayout.PropertyField(driveTypeProp, new GUIContent("Drive Type"));
        serializedObject.ApplyModifiedProperties();

        EditorGUILayout.IntSlider(maxSpeed, 20, 300, new GUIContent("Max Speed:"));
        EditorGUILayout.IntSlider(maxReverseSpeed, 10, 120, new GUIContent("Max Reverse Speed:"));
        EditorGUILayout.IntSlider(accelerationMultiplier, 1, 50, new GUIContent("Acceleration Multiplier:"));
        ...
        EditorGUILayout.PropertyField(FLWParticleSystem, new GUIContent("Front Left Particle System:"));
        EditorGUILayout.PropertyField(FRWParticleSystem, new GUIContent("Front Right Particle System:"));
        GUILayout.Space(10);
        ...
        EditorGUILayout.PropertyField(FLWTireSkid, new GUIContent("Front Left Trail Renderer:"));
        EditorGUILayout.PropertyField(FRWTireSkid, new GUIContent("Front Right Trail Renderer:"));
